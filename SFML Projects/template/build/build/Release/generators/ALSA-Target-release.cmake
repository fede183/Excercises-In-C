...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET ALSA::ALSA
                 ...
                 $<$<CONFIG:Release>:${libalsa_LINKER_FLAGS_RELEASE}> APPEND)
    set_property(TARGET ALSA::ALSA
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${libalsa_INCLUDE_DIRS_RELEASE}> APPEND)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET ALSA::ALSA
                 PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${libalsa_LIB_DIRS_RELEASE}> APPEND)
    set_property(TARGET ALSA::ALSA
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${libalsa_COMPILE_DEFINITIONS_RELEASE}> APPEND)
    set_property(TARGET ALSA::ALSA
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${libalsa_COMPILE_OPTIONS_RELEASE}> APPEND)
